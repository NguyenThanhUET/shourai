                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="date" id="start_time" class="datepicker form-control" value="{{$dataTour->start}}">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label class="control-label" for="page_name">End Time</label>
                                            <input type="date" id="end_time" class="datepicker form-control" value="{{$dataTour->end}}">
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="number" id="price" class="form-control" value="{{$dataTour->price}}">
                                        </div>
                                        <div class="form-group col-md-6">
