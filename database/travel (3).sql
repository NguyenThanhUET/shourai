...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 31, 2019 at 02:45 PM
...
(1, 'Tokyo', '東京', 'https://www.saigontourist.net/uploads/destination/TrongNuoc/Nhatrang/Vinpearl-Land_781467691.jpg', '東京都が管轄する領域は東京都区部（東京23区）、多摩地域（26市[注 3]と西多摩郡3町1村）および東京都島嶼部（大島、三宅、八丈、小笠原）の4支庁（2町7村）からなっている。東京都区部（東京23区）は、一つの都市として「東京」とも呼ばれる。沖ノ鳥島、南鳥島を含む小笠原諸島を含むため、日本最南端および最東端に位置する都道府県でもある。都公認の「東京都」の英語表記はTokyo Metropolis (Tokyo Met.) 。他には Tokyo Prefecture と Tokyo Metropolitan Prefecture がある。'),
...
(4, 4, 4, 'Osaka', '夏の北海道は、北海道新幹線開業で大賑わい！定番の函館をはじめ、世界自然遺産の知床や人気の旭山動物園など、魅力的な観光スポットが満載！ ウニや夕張メロンなど、北海道ならではの「食」もお楽しみください。', '2021-01-12', '2021-01-16', 6, 1),
(5, 7, 2, 'dhhhghj,kn', NULL, NULL, NULL, NULL, NULL),
(6, 6, 4, '67889', NULL, '2021-01-13', '2021-01-20', 5890, NULL),
(7, 4, 3, 'hfjaf ', '434465', '2020-01-15', '2020-01-18', 2000, NULL);
